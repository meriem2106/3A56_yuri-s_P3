 ...
 */
final class Version20240306164548 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_404021BFF347EFB ON formation');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_404021BFF347EFB ON formation (produit_id)');
    }
}
